...
import {EditSiteCards} from "../Variations"
        ...
        <>
            {siteUrl.endsWith('/person') &&
                <Panel border className="rediger">
                    ...
                    {/* <Heading className="cardsubtitle" spacing size="xsmall" level="3">
                    Åpne siden i
                    </Heading> */}
                    <ul>
                        <EditSiteCards siteUrl={siteUrl} />
                    ...
                    {/* <Heading className="cardsubtitle2" spacing size="xsmall" level="3">
                    Slack: <Link target="_blank" href="https://nav-it.slack.com/archives/C9CJ794PP">#team-personbruker</Link>
                    </Heading> */}
                </Panel>
            }
            ...
            {siteUrl.match('pensjon') && siteUrl.match('nav.no') &&
                <Panel border className="rediger">
                    ...
                    {/* <div className="cardsubtitle2">
                        <Link target="_blank" href="https://nav-it.slack.com/archives/C02J5RJ7LPJ">Slackdialog om innhold</Link>
                    </div> */}
                </Panel>
            }
            ...
            {siteUrl.match('teamkatalog.nais.adeo.no') &&
                   <Panel border className="rediger">
                    ...
                    <ul>
                        ...
                        <li><Link target="_blank" href="https://dataplattform.gitbook.io/nada/kataloger/teamkatalog">NADA</Link> (dokumentasjon)</li>
